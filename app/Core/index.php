...
<body ng-app="codedrive" ng-cloak ng-controller="codedriveCtrl" layout="column" ng-init="getfiles('/opt/lampp/htdocs/File/Parthiban')">
<!--Header -->
...
<md-sidenav class="md-sidenav-right md-whiteframe-4dp" md-component-id="right">
    ...
    <!-- Folder Sub Header -->
        ...
        <md-list  layout="row" class="md-whiteframe-z2 overflow">
          ...
          <md-button class="md-secondary" ng-click="deletefile();">
           ...
           <div class="container">
           <ul class="breadcrumb">
           <li class="breadcrumb-item" ng-model="breadcrumb" ng-repeat="i in arr" >
           <label ng-href="{{i.link}}" style="color:blue" ng-click="getfiles(i.link);" >{{i.name}}</label></li>
           </ul>
           </div>
           </md-list>
           <div layout="row" layout-padding style="padding:20px;background-color:" > 
                <table class="table table-hover" >
                    ...
                    <tbody ng-repeat="file in files  track by $index " ng-class="{'selected':$index == selectedRow}" ng-click="setClickedRow($index)">
                            <td><md-checkbox ng-model="file.option" value="{{file.path}}" aria-label="Checkbox 1"></md-checkbox></td>
                            <td ng-show="file.type=='dir'">
                            <md-icon md-font-set="material-icons">folder</md-icon>
                            <label ng-href="{{file.path}}" ng-click="getfiles(file.path);"  style="text-decoration:none">{{file.basename}}</label>
                            </td>
                            <td ng-show="file.type=='file'">
                            <md-icon  md-font-set="material-icons">description</md-icon>
                            <label ng-href="{{file.path}}"   style="text-decoration:none">{{file.basename}}</label></td>
                            <td>{{file.size}}</td>
                            <td>{{file.extension}}</td>
                            <td>{{file.ltime}}</td>
                            <td>{{file.permission}}</td>
                            <td><a ng-href="{{file.path}}"  Download>
                            <md-button class="md-primary md-hue-2" ng-disabled="file.type=='dir'"><md-icon ng-show="file.type=='file'" md-font-set="material-icons">file_download</md-icon>
                            <md-button</a></td>
                    </tbody>
                </table>
            </div>
        ...
        <div class="md-dialog-container"  id="createfolder">
             ...
             <md-toolbar style="width:500px">
                ...
                <div layout="row" >
                        ...
                        <div flex=""></div>
                        <md-button class="md-primary" ng-click="createnewfolder();" >Create Folder</md-button>
                        </div>
             </md-dialog>
        </div>
  </div>
        ...
        <div class="md-dialog-container"  id="createfile">
             ...
             <md-toolbar style="width:500px">
                ...
                <div layout="row" >
                        <md-button ng-click="dircancel();" style="background-color:red;color:white">Cancel</md-button>
                        <div flex=""></div>
                             <md-button class="md-primary" ng-click="createnewfile()"  >Create</md-button>
                        </div>
             </md-dialog>
        </div>
  </div>
